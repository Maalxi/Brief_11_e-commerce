 ...
 */
final class Version20230718140633 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_reservation (product_id INT NOT NULL, reservation_id INT NOT NULL, quantity INT NOT NULL, INDEX IDX_EEE7D74A4584665A (product_id), INDEX IDX_EEE7D74AB83297E7 (reservation_id), PRIMARY KEY(product_id, reservation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, promotion_id INT DEFAULT NULL, price DOUBLE PRECISION NOT NULL, price_final DOUBLE PRECISION NOT NULL, validation TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_42C84955139DF194 (promotion_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, last_name VARCHAR(100) NOT NULL, first_name VARCHAR(100) NOT NULL, tel VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
