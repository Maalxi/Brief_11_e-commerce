 ...
 */
final class Version20230719124422 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, promotion_id INT DEFAULT NULL, user_id INT NOT NULL, price DOUBLE PRECISION NOT NULL, price_final DOUBLE PRECISION NOT NULL, validation TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_42C84955139DF194 (promotion_id), INDEX IDX_42C84955A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
